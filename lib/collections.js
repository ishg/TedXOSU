  ...
  if (Speakers.find().count() == 0){
    ...
    var speakers = [
      ...
      },
      {
        ...
        title: "Idealist",
        lines: [
          "Hollie Nyseth Brehm is an Assistant Professor of Sociology at Ohio State, where she teaches classes on conflict, global crime, and terrorism. Her research focuses on the causes and processes of genocide and on how countries rebuild in the aftermath of atrocity. She has lived and worked in Rwanda and Bosnia, where she interviewed both perpetrators and victims of genocide.",
      ...
      {
        name: "John S. Carlarne, DPhil",
        picture: "headshots/carlarne.jpg",
        title: "Confused",
        lines: [
          "Dr. Carlarne was born in Kenya, and grew up in Nairobi and London. He has spent much of my life trying and failing to understand what it means to alive. His work around the world as a British Army officer, police officer, peace and human rights activist has taken him to places of genocide and violence, and to communities of peace and hope. He has been fortunate to witness the best and worst in people. Now Dr. Carlarne is working with wonderful colleagues and friends to make Columbus a hub for peace and nonviolence. An anthropologist by training, his current research focuses on the evolutionary basis of meaning."
        ]
      },
      {
